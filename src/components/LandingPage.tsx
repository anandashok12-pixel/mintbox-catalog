      ...
      <nav id="navbar" role="navigation" aria-label="Main navigation">
        <a href="#" className="nav-logo" aria-label="MintBox Home">
          <svg className="nav-logo-bow" viewBox="0 0 56 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M28 14 C20 6 8 4 4 10 C2 13 6 17 12 14 C18 11 24 14 28 14 C32 14 38 11 44 14 C50 17 54 13 52 10 C48 4 36 6 28 14Z" stroke="#1B4D3E" strokeWidth="1.2" fill="none"/>
            <path d="M28 14 C26 12 26 10 28 8 C30 10 30 12 28 14Z" fill="#1B4D3E" opacity="0.7"/>
            <path d="M22 18 C24 20 28 20 28 18" stroke="#1B4D3E" strokeWidth="0.8" fill="none"/>
            <path d="M34 18 C32 20 28 20 28 18" stroke="#1B4D3E" strokeWidth="0.8" fill="none"/>
          </svg>
